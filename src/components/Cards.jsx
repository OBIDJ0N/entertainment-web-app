      ...
      <CardContent>
        ...
        <Box className="mt-[6.625rem] ms-6 max-phone:mt-8 max-phone:ml-4">
          <Stack display={'flex'} flexDirection={'row'} alignItems={'center'}>
            ...
            <Typography className='max-phone:text-sm' ml={'6px'}>{item.media_type === 'movie' ? item.media_type[0].toUpperCase() + item.media_type.slice(1) : item.media_type.toUpperCase() + ' Series'}</Typography>
          </Stack>
